...
class FunctionalTests(unittest.TestCase):
    ...
    def test_api_calls_fail_with_wrong_token(self):
        ...
        self.testapp.get('/api/dossier/change_access_hash.json?token=' + t + '&owner_hash=1111111111111111&new_access_hash=3333333333333333&old_access_hash=2222222222222222', status=200)
        self.testapp.get('/api/dossier/change_access_hash.json?token=invalid&owner_hash=1111111111111111&new_access_hash=4444444444444444&old_access_hash=3333333333333333', status=403)
        self.testapp.get('/api/dossier/change_access_hash.json?owner_hash=1111111111111111&new_access_hash=4444444444444444&old_access_hash=3333333333333333', status=403)
